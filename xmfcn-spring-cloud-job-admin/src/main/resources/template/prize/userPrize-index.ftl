        ...
        <section class="content">
            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-body">
                            <table id="userPrize_table" class="table table-striped table-hover table-condensed"
                                   width="100%" style="white-space: nowrap;">
                                <thead>
                                <tr>
                                    <th name="id">id</th>
                                    <th name="type">类型</th>
                                    <th name="imgUrl">图片</th>
        ...
        <div class="modal-content">
            <div class="modal-header">
                <table width="99%">
                    <tr>
                        <td style="width: 15%">
                            <h4 class="modal-title">保存奖品信息</h4>
                        </td>
                        <td style="width: 77%">
                        </td>
                        <td style="width: 8%">
            ...
            <div class="modal-body">
                <form class="form-horizontal form" role="form">
                    ...
                    <div class="form-group">
                        <label for="imgUrl" class="col-sm-2 control-label">图片<font color="red">*</font></label>
                        <div class="col-sm-10"><input type="text" class="form-control" name="imgUrl"
                                                      placeholder="请输入..."
                                                      maxlength="255"></div>
                    </div>
                    <hr>
...
//拖拽
<script src="/jobadmin/js/userPrize.index.js"></script>
