...
<head>
    ...
    <link rel="stylesheet" href="/job/adminlte/plugins/iCheck/square/blue.css">
...
<script src="/job/adminlte/plugins/iCheck/icheck.min.js"></script>
<script src="/job/js/login.1.js"></script>
