...
public class CodeTableService  {
    ...
    private SysCommonService sysCommonService;
     private static Logger logger = LoggerFactory.getLogger(CodeTableService.class);
	   ...
	   * @return
	   */
	   public List<CodeTable>  getCodeTableList(@RequestBody CodeTable codeTable)
	   {
	 ...
	 * @return
	 */
	public CodeTable save(@RequestBody CodeTable codeTable)
	{
	    String parms = JSON.toJSONString(codeTable);
	   ...
	   * @return
	   */
	   public CodeTable  getCodeTable(@RequestBody CodeTable codeTable)
	   {
	      CodeTable ret=null;
	      String parms = JSON.toJSONString(codeTable);
	      List<CodeTable> list=null;
