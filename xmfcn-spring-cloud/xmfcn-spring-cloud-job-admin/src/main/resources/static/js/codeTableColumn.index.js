    ...
    var codeTableColumnTable = $("#codeTableColumn_table").dataTable({
        ...
        "ajax": {
            ...
            data: function (d) {
                ...
                obj.jdbcType = $('#jdbcType').val();
                obj.javaType = $('#javaType').val();
                obj.javaField = $('#javaField').val();
                obj.isPk = $('#isPk').val();
                obj.isNull = $('#isNull').val();
                obj.isInsert = $('#isInsert').val();
                obj.isEdit = $('#isEdit').val();
                obj.isList = $('#isList').val();
                obj.isQuery = $('#isQuery').val();
                obj.queryType = $('#queryType').val();
                obj.showType = $('#showType').val();
                obj.dictType = $('#dictType').val();
                obj.settings = $('#settings').val();
                obj.sort = $('#sort').val();
                obj.remark = $('#remark').val();
                obj.tableName = $('#tableName').val();
                obj.isEditpage = $('#isEditpage').val();
                obj.isinsertrequiredfield = $('#isinsertrequiredfield').val();
                obj.isupdaterequiredfield = $('#isupdaterequiredfield').val();
                obj.start = d.start;
                obj.length = d.length;
                return obj;
            }
