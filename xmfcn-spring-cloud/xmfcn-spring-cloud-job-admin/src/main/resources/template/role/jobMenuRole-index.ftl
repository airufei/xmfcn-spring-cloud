        ...
        <section class="content">
            ...
            <div class="row">
                <div class="col-xs-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" id="roleId" autocomplete="on">
                    </div>
              </div>
                <div class="col-xs-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" id="menuId" autocomplete="on">
                    </div>
              </div>
                <div class="col-xs-1">
            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-body">
                            <table id="jobMenuRole_table" class="table table-striped table-hover table-condensed" width="100%" style="white-space: nowrap;">
                                <thead>
                                <tr>
                                    <th name="id">主键ID</th>
                                    <th name="roleId">角色ID</th>
                                    <th name="menuId">菜单ID</th>
                                    <th name="createTime">创建时间</th>
                                    <th name="updateTime">修改时间</th>
                                    <th name="flag">删除标记 -1删除 1正常</th>
        ...
        <div class="modal-content">
            <div class="modal-header">
                <table width="99%">
                    <tr>
                        <td style="width: 15%">
                            <h4 class="modal-title">保存角色菜单关系</h4>
                        </td>
                        <td style="width: 77%">
                        </td>
                        <td style="width: 8%">
            ...
            <div class="modal-body">
                <form class="form-horizontal form" role="form">
                    <div class="form-group">
                        <label for="roleId" class="col-sm-2 control-label">角色ID<font color="red">*</font></label>
                        <div class="col-sm-10"><input type="text" class="form-control" name="roleId" placeholder="请输入..."
                           maxlength="20"></div>
                    </div>
                    <div class="form-group">
                        <label for="menuId" class="col-sm-2 control-label">菜单ID<font color="red">*</font></label>
                        <div class="col-sm-10"><input type="text" class="form-control" name="menuId" placeholder="请输入..."
                           maxlength="20"></div>
                    </div>
                    <div class="form-group">
...
<#--<script src="/jobadmin/js/jobMenuRole.index.js"></script>-->
