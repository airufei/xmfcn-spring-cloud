...
<head>
    ...
    <link rel="stylesheet" href="/jobadmin/adminlte/plugins/iCheck/square/blue.css">
...
<script src="/jobadmin/adminlte/plugins/iCheck/icheck.min.js"></script>
<script src="/jobadmin/js/login.1.js"></script>
