                        ...
                        <div class="box-body" style="overflow-x: scroll;">
                            <table id="codeTableColumn_table" class="table table-striped table-hover table-condensed"
                                ...
                                <tr>
                                    ...
                                    <td name="javaType"> <select name="javaType" class="required input-mini" style="width:90px">
                                    ...
                                    <td name="tableName"><input type="text"  name="tableName"  value="${li.tableName}" readonly="readonly" style="background:#CCCCCC"/></td>
                                    <td name="jdbcType"><input type="text" name="jdbcType"  value="${li.jdbcType}" readonly="readonly" style="background:#CCCCCC"/></td>
                                </tr>
                                </#list>
